...
function ThreeSixtyPlayer() {
  ...
  this.config.playNext = false;
  this.config.autoPlay = false;
  this.config.allowMultiple = false;
  this.config.loadRingColor = '#000000';
  this.config.playRingColor = '#FFC03F';
  this.config.backgroundRingColor = '#333333';
  this.config.circleDiameter = null;
  this.config.circleRadius = null;
  this.config.animDuration = 1000;
  this.config.animTransition = Animator.tx.bouncy;
  this.config.showHMSTime = false;
  this.config.useWaveformData = true;
  this.config.waveformDataColor = '#FFC949';
  this.config.waveformDataDownsample = 2;
  this.config.waveformDataOutside = false;
  this.config.waveformDataConstrain = false;
  // this.config.waveformDataLineRatio = 0.9;
  this.config.useEQData = true;
  this.config.eqDataColor = '#FFFFFF';
  this.config.eqDataDownsample = 2;
  this.config.eqDataOutside = true;
  // this.config.eqDataLineRatio = 0.54;
  this.config.usePeakData = true;
  this.config.peakDataColor = '#ff33ff';
  this.config.peakDataOutside = true;
  // this.config.peakDataLineRatio = 0.9;
  this.config.useAmplifier = true;
  this.config.scaleArcWidth = .33;
